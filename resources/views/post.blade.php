        ...
        <div class="col-md-4">
            ...
            <div class="card my-3">
                ...
                <div class="card-body post-widgets text-center">
                    ...
                    <button type="button" class="btn btn-warning btn-block publish mt-4" postId="{{$post->id}}"
                        postStatus="{{$post->getRawOriginal('status')}}">{{ trans('lang.Hide') }}</button>
                    @else
                    <button type="button" class="btn btn-success btn-block publish mt-4" postId="{{$post->id}}"
