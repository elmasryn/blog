    ...
    <div class="container">
        <div class="row justify-content-center py-5">
            ...
            <div class="col-md-8">
                ...
                @if (request('category') && $category->getRawOriginal('status') != '1')
                    <div class="alert alert-danger m-2 text-center d-block" role="alert">
                        <strong>{{ __('lang.This category is not active') }}</strong>
                    </div>
                @endif
                            ...
                            <li class="media"> {{-- <<<<<<<<<<<<< image --}}
                                <a class="text-dark" href="{{ url('posts/' . $post->slug) }}">
                                    @isset($post->thumbnail)
                                        <img src="{{ asset($post->thumbnail) }}" class="mr-3"
                                ...
                                <div class="media-body">
                                    ...
                                    <h6 class="mb-0"><span><i class="fas fa-user"></i></span>
                                        {{ trans('lang.By') }}
                                    ...
                                    <ul class="list-inline list-unstyled">
                                        ...
                                        <li class="list-inline-item">
                                            <span class="ml-1">
                                                ...
                                                <span class="text-danger font-weight-bold">{{ $post->comments_count }}
                                                </span>
            ...
            <div class="col-md-4">
                ...
                @if (request('category') and (isset($category->desc_ar) or isset($category->desc_en)))
                    <div class="card my-3">
                        ...
                        <div class="card-body">
                            {{ $category->{'desc_' . app()->getLocale()} ?? ($category->desc_en ?? $category->desc_ar) }}
                        </div>
                    </div>
                @endif
