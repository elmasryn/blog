...
@section('title' , '| '.__('lang.The tags'))
@push('css')
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">{{ trans('lang.The tags') }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class=" breadcrumb-item"><a href="{{adminurl('')}}/">{{ trans('lang.Home') }}</a></li>
                        <li class="breadcrumb-item active">{{ trans('lang.The tags') }}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="container">
                    <form id="del_form" method="POST" action="{{route(adminview('tags.multidestroy'))}}">
                        @csrf
                        @method('DELETE')
                        {!! $dataTable->table(['class' => 'table table-bordered table-striped table-hover
                        w-100 text-center'],true) !!}
                        @include('admin.tags_del_multi')
                    </form>
                </div>
