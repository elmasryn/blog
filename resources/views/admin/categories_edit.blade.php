...
@section('title' , '| '.__('lang.Edit category'))
@section('content')
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">{{ trans('lang.Edit category') }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans('lang.Edit category') }}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="container">
                    <form method="POST" action="{{ route(adminview('categories.update'),$category->id)}}" class=" w-50">
                        @csrf
                        @method('PUT')
                        <div class="form-group border-bottom p-3">
                            ...
                            <input id="title_en" type="text"
                                value="{{ old('title_en' , optional($category)->title_en , '')}}"
                        ...
                        <div class="form-group border-bottom p-3">
                            ...
                            <input type="text" id="title_ar"
                                value="{{ old('title_ar', optional($category)->title_ar , '')}}"
                        ...
                        <div class="form-group border-bottom p-3">
                            ...
                            @error('desc_en') is-invalid @enderror" name="desc_en" cols="40"
                                rows="7">{{ old('desc_en' , optional($category)->desc_en , '') }}</textarea>
                            @error('desc_en')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="form-group border-bottom p-3">
                            ...
                            is-invalid @enderror" name="desc_ar" cols="40"
                                rows="7">{{ old('desc_ar' , optional($category)->desc_ar , '') }}</textarea>
                            @error('desc_ar')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="form-group border-bottom p-3">
                            ...
                            <select id="status" class="form-control @error('status') is-invalid @enderror"
                                name="status">
                                <option value="1"
                                    {{ old('status' , optional($category)->getRawOriginal('status') , '1') == '1' ? 'selected' : '' }}>
                                    {{ trans('lang.Published') }}</option>
                                <option value="0"
                                    {{ old('status' , optional($category)->getRawOriginal('status') , '1') == '0' ? 'selected' : '' }}>
                        ...
                        <div class="form-group border-bottom p-3">
                            <button type="submit" class="btn btn-primary">{{ trans('lang.Edit category') }}</button>
                        </div>
                    </form>
