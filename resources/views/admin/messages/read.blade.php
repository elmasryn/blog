...
@section('title' , '| '.__('lang.Read messages'))
@section('mailContent')
@section('breadcrumb')
<li class="breadcrumb-item active">{{ trans('lang.Read messages') }}</li>
@endsection

<div class="col-md-9">
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title">{{ __('lang.Read messages') }}</h3>
        ...
        <div class="card-body p-0">
            <div class="mailbox-controls">
                ...
                <div class="float-right">
                    {{$readMessages->firstItem()}}-{{$readMessages->lastItem()}}/{{$readMessages->total()}}
                    <div class="btn-group">
                        <a type="button" href="{{$readMessages->nextPageUrl()}}"
                            class="btn btn-default btn-sm {{$readMessages->hasMorePages() ? '' : 'disabled'}}"><i
                                class="fas fa-chevron-left"></i></a>
                        <a type="button" href="{{$readMessages->previousPageUrl()}}"
                            class="btn btn-default btn-sm {{$readMessages->onFirstPage() ? 'disabled' : ''}}"><i
