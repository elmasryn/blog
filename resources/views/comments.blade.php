                ...
                <div id="comment{{$comment->id}}" class="d-flex flex-row comment-row m-t-0">
                    <div class="p-2">
                        ...
                        <a href="{{url('profile/'.$comment->user_id)}}">
                            <img src="{{url('img/avatar/default.png')}}" alt="{{$comment->name}}" width="50" height="50"
                        ...
                        @else
                        <a href="{{url('profile/'.$comment->user_id)}}">
                            <img src="{{url($comment->user->profile->avatar)}}" alt="{{$comment->name}}" width="50"
                    ...
                    <div class="comment-text w-100">
                        ...
                        <div class="comment-footer">
                            ...
                            @endif
                            <span class="text-muted float-right">{{ $comment->created_at->format('F j, Y') }}</span>
                            ...
                            <button type="button" class="btn btn-warning btn-sm publish" commentId="{{$comment->id}}"
                                commentStatus="{{$comment->getRawOriginal('status')}}">{{ trans('lang.Hide') }}</button>
                            @else
                            <button type="button" class="btn btn-success btn-sm publish" commentId="{{$comment->id}}"
